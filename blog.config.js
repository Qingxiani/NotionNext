...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，不要为打翻的牛奶哭泣~,Hi，我是一个干饭人,不要被贩卖焦虑~,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'poze624', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '天行健，君子以自强不息', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://poze624.top', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/qingxiani', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/touxiang.jpg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'POZE BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '时间 思想 可能性', // 站点描述，被notion中的页面描述覆盖
